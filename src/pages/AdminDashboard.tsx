...
import { Users, Truck, Heart, Trash2, Edit } from 'lucide-react';
...
export function AdminDashboard() {
  ...
  if (!currentUser || currentUser.role !== 'admin') return <div className="p-8 text-center text-red-500">Access Denied</div>;
